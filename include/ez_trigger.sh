...
#SBATCH --output=/home/zat/CLAEF/suite/claef/ez_trigger.txt

##### Start with ecaccess-job-submit -ni e_ms144 -queueName hpc -mp "nothing to be done" -rc 1 ./ez_trigger.sh ######
...
echo "hallo1" >> /home/zat/triggertest.txt
#(( HRUN = $HPROD + $lagg))
#if [[ $HRUN -ge 24 ]]
#then
#   (( HRUN = $HRUN - 24))
...
#
#echo "hallo2" >> /home/zat/triggertest.txt
#echo $HPROD >> /home/zat/triggertest.txt
# Set task complete for ecFlow
#module load ecflow
#export ECF_HOST=ecflow-tc2-zat-001
